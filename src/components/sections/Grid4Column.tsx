...
export default function Grid4Column() {
  return (

    <section className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0"><h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Grid4Column Grid</h2></div>
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-8 sm:mt-16 sm:grid-cols-2 lg:grid-cols-4 lg:max-w-none">
          {[1,2,3,4].map(i => (
